...
<html lang="en">
  ...
  <head>
    ...
    <title>Engineer Masters Online Examination</title>
              ...
              <div class="col-12">
                  <nav class="main-nav">
                      ...
                      <ul class="nav">
                          ...
                          @endauth
                          @endif
                          <li><a href="{{ route('viewExam') }}">Exams</a></li>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="owl-service-item owl-carousel">
            ...
            <div class="item">
              <div class="icon">
                <img src="{{ asset('asset/images/service-icon-01.png') }}" alt="">
              </div>
              <div class="down-content">
                <h4>Best Working Experience</h4>
            ...
            <div class="item">
              <div class="icon">
                <img src="{{ asset('asset/images/service-icon-02.png') }}" alt="">
              </div>
              <div class="down-content">
                <h4>Best Team Leaders</h4>
                <p>Suspendisse tempor mauris a sem elementum bibendum. Praesent facilisis massa non vestibulum.</p>
              </div>
            </div>
            ...
            <div class="item">
              <div class="icon">
                <img src="{{ asset('asset/images/service-icon-03.png') }}" alt="">
              </div>
              <div class="down-content">
                <h4>Best Co-Workers</h4>
                <p>Suspendisse tempor mauris a sem elementum bibendum. Praesent facilisis massa non vestibulum.</p>
              </div>
            </div>
            ...
            <div class="col-lg-6">
              <div class="meeting-item">
                <div class="thumb">
                  ...
                  <a href="#"><img src="{{ asset('asset/images/meeting-01.jpg') }}" alt="New Lecturer Meeting"></a>
                </div>
                <div class="down-content">
                  <div class="date">
            ...
            <div class="col-lg-6">
              <div class="meeting-item">
                <div class="thumb">
                  ...
                  <a href="#"><img src="{{ asset('asset/images/meeting-02.jpg') }}" alt="Online Teaching"></a>
                </div>
                <div class="down-content">
                  <div class="date">
            ...
            <div class="col-lg-6">
              <div class="meeting-item">
                <div class="thumb">
                  ...
                  <a href="#"><img src="{{ asset('asset/images/meeting-03.jpg') }}" alt="Higher Education"></a>
                </div>
                <div class="down-content">
                  <div class="date">
            ...
            <div class="col-lg-6">
              <div class="meeting-item">
                <div class="thumb">
                  ...
                  <a href="#"><img src="{{ asset('asset/images/meeting-04.jpg') }}" alt="Student Training"></a>
                </div>
                <div class="down-content">
                  <div class="date">
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="owl-courses-item owl-carousel">
            <div class="item">
              <img src="{{ asset('asset/images/course-01.jpg') }}" alt="Course One">
              <div class="down-content">
            ...
            <div class="item">
              <img src="{{ asset('asset/images/course-02.jpg') }}" alt="Course Two">
              <div class="down-content">
            ...
            <div class="item">
              <img src="{{ asset('asset/images/course-03.jpg') }}" alt="">
              <div class="down-content">
            ...
            <div class="item">
              <img src="{{ asset('asset/images/course-04.jpg') }}" alt="">
              <div class="down-content">
            ...
            <div class="item">
              <img src="{{ asset('asset/images/course-01.jpg') }}" alt="">
              <div class="down-content">
            ...
            <div class="item">
              <img src="{{ asset('asset/images/course-02.jpg') }}" alt="">
              <div class="down-content">
  ...
  <section class="our-facts">
    <div class="container">
      <div class="row">
              ...
              <div class="row">
                <div class="col-12">
                  <div class="count-area-content percentage">
                    ...
                    <div class="count-title">Succesed Team Leaders</div>
                  </div>
                </div>
                <div class="col-12">
                  <div class="count-area-content">
                    <div class="count-digit">100</div>
                    <div class="count-title">Current Employees</div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="row">
                <div class="col-12">
                  <div class="count-area-content new-students">
                    ...
                    <div class="count-title">New Employees</div>
                  </div>
                </div> 
                <div class="col-12">
                  <div class="count-area-content">
        ...
        <div class="col-lg-6 align-self-center">
          <div class="video">
            <a href="https://www.youtube.com/watch?v=HndV87XpkWg" target="_blank"><img src="{{ asset('asset/images/play-icon.png') }}" alt=""></a>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="col-lg-3">
          <div class="right-info">
            <ul>
              ...
              <li>
                <h6>Email Address</h6>
                <span>info@engineermaster.in</span>
              </li>
              <li>
                <h6>Street Address</h6>
                <span>MPSEC Building - Electronic Complex , Indore</span>
              </li>
              <li>
                <h6>Website URL</h6>
                <span>www.engineermasters.in</span>
              </li>
            </ul>
          </div>
        </div>
